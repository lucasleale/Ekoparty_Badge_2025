...
/*#if defined(USE_PCM_CUSTOM)
  #include "pcm_custom.h"
#elif defined(USE_PCM_CUSTOM2)
  #include "pcm_custom2.h"
#elif defined(USE_PCM_TINY)
  #include "pcm_tiny.h"
#elif defined(USE_PCM_SMALL)
  #include "pcm_small.h"
#elif defined(USE_PCM_LARGE)
  #include "pcm_large.h"
#else
  #include "pcm_tiny.h"  // default si no se define nada
#endif*/
// --- Safety fallback: si PROGMEM no existe, que sea vacío ---
...
#else
#define AMY_BLOCK_SIZE 256 //64
#define BLOCK_SIZE_BITS 8 // log2 of BLOCK_SIZE //6
#endif
